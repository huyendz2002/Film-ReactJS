...
const Category = (props) => {
  ...
  const styles = { transform: ` translateX(${count * -17.3 * 5}rem)` };
  return (
    <div className=" h-[26rem]  mt-4 overflow-hidden relative ">
      <div className=" top-0 text-white font-semibold text-xl flex justify-between items-center">
        {props.name}
      ...
      <div
        style={styles}
        className="absolute flex shrink-0 gap-[1.3rem] w-auto h-[23rem]  top-10 transition-all"
      >
...
const CategoryItem = (props) => {
  return (
    <div className="w-[16rem] h-full bg-slate-800 p-3 rounded-lg relative  ">
      <img
